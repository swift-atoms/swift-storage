// MARK: - Variant 2: Core Module
// Type definition with deinit in Core module
// Extensions in separate module with public import
...
public enum Storage<Element: ~Copyable> {
    public struct Inline<let capacity: Int>: ~Copyable {
        ...
        deinit {
            print("Variant2 Storage.Inline deinit called (count=\(_count))")
            _tracker?.increment()
