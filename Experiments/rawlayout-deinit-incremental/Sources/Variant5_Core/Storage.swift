// MARK: - Variant 5: Core Module
// Type definition with deinit - mirrors Storage Primitives Core
...
public enum Storage<Element: ~Copyable> {
    ...
    public struct Inline<let capacity: Int>: ~Copyable {
        ...
        deinit {
            print("Variant5 Storage.Inline deinit called")
            _tracker?.increment()
            self.deinitialize()
        }
    }

    /// Placeholder for Heap storage (to mirror real package structure)
