// MARK: - Variant 5 Tests
// Testing: Multi-module import graph (mirrors real failing test structure)
// Expected: Unknown - this mirrors the exact import pattern of the failing test

import Testing
import Synchronization
import Variant5_Core
import Variant5_Inline
import Variant5_Heap
import Variant5_TestSupport
...
@Suite("Variant 5: Multi-Module Import Graph")
struct Variant5Tests {
    ...
    func markerClassDeinit() {
        ...
        do {
            ...
            storage.initialize(to: Marker(), at: Index<Marker>.zero)
            storage.initialize(to: Marker(), at: Index<Marker>(1))
