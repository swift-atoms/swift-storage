...
/// |------|--------|-----------|
/// | Automatic cleanup, contiguous elements | `Storage.Heap` (= `Storage.Contiguous<Memory.Heap<E>>`) | **Tracked** — the `Store.Initialization` ledger lives in the leaf's backing class, whose `deinit` is the cleanup oracle |
...
///
/// `Storage.Heap` is, post the storage/memory split, the composition of the
